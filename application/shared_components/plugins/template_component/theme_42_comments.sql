...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(180848550843957987)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1980734022728989706)
,p_plugin_id=>wwv_flow_imp.id(180848550843957987)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180849025075957991)
,p_plugin_id=>wwv_flow_imp.id(180848550843957987)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180849366023957992)
,p_plugin_id=>wwv_flow_imp.id(180848550843957987)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180849648258957992)
,p_plugin_id=>wwv_flow_imp.id(180848550843957987)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180849997482957992)
,p_plugin_id=>wwv_flow_imp.id(180848550843957987)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180850286580957993)
,p_plugin_id=>wwv_flow_imp.id(180848550843957987)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(180854883126957998)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1980734022728989706)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180850500417957993)
,p_plugin_attribute_id=>wwv_flow_imp.id(180850286580957993)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180850969212957994)
,p_plugin_attribute_id=>wwv_flow_imp.id(180850286580957993)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180851341505957994)
,p_plugin_attribute_id=>wwv_flow_imp.id(180850286580957993)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180851731020957994)
,p_plugin_id=>wwv_flow_imp.id(180848550843957987)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(180850286580957993)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180852001692957995)
,p_plugin_id=>wwv_flow_imp.id(180848550843957987)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180852393054957995)
,p_plugin_id=>wwv_flow_imp.id(180848550843957987)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180852663204957996)
,p_plugin_id=>wwv_flow_imp.id(180848550843957987)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180852902448957996)
,p_plugin_id=>wwv_flow_imp.id(180848550843957987)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180853224795957996)
,p_plugin_attribute_id=>wwv_flow_imp.id(180852902448957996)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180853686373957997)
,p_plugin_attribute_id=>wwv_flow_imp.id(180852902448957996)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180854027146957997)
,p_plugin_attribute_id=>wwv_flow_imp.id(180852902448957996)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180854453761957998)
,p_plugin_attribute_id=>wwv_flow_imp.id(180852902448957996)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180854883126957998)
,p_plugin_id=>wwv_flow_imp.id(180848550843957987)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180855154094957998)
,p_plugin_id=>wwv_flow_imp.id(180848550843957987)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180855475015957999)
,p_plugin_id=>wwv_flow_imp.id(180848550843957987)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180855763555957999)
,p_plugin_attribute_id=>wwv_flow_imp.id(180855475015957999)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180856175449958000)
,p_plugin_attribute_id=>wwv_flow_imp.id(180855475015957999)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180856555064958000)
,p_plugin_id=>wwv_flow_imp.id(180848550843957987)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1980866690162091209)
,p_plugin_id=>wwv_flow_imp.id(180848550843957987)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1980866098657083752)
,p_plugin_id=>wwv_flow_imp.id(180848550843957987)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1980921722327065631)
,p_plugin_id=>wwv_flow_imp.id(180848550843957987)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1981073940039936402)
,p_plugin_id=>wwv_flow_imp.id(180848550843957987)
