...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(180830617385957924)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180830998747957941)
,p_plugin_id=>wwv_flow_imp.id(180830617385957924)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180831215132957945)
,p_plugin_attribute_id=>wwv_flow_imp.id(180830998747957941)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180831652289957948)
,p_plugin_attribute_id=>wwv_flow_imp.id(180830998747957941)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180832058842957948)
,p_plugin_attribute_id=>wwv_flow_imp.id(180830998747957941)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180832409803957949)
,p_plugin_id=>wwv_flow_imp.id(180830617385957924)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(180830998747957941)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180832727415957949)
,p_plugin_id=>wwv_flow_imp.id(180830617385957924)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180833009329957950)
,p_plugin_id=>wwv_flow_imp.id(180830617385957924)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180833393504957950)
,p_plugin_id=>wwv_flow_imp.id(180830617385957924)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180833664309957950)
,p_plugin_id=>wwv_flow_imp.id(180830617385957924)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180833968052957951)
,p_plugin_attribute_id=>wwv_flow_imp.id(180833664309957950)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180834376002957951)
,p_plugin_attribute_id=>wwv_flow_imp.id(180833664309957950)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180834728137957952)
,p_plugin_attribute_id=>wwv_flow_imp.id(180833664309957950)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180835172190957952)
,p_plugin_attribute_id=>wwv_flow_imp.id(180833664309957950)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180835523821957952)
,p_plugin_id=>wwv_flow_imp.id(180830617385957924)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180835813374957953)
,p_plugin_attribute_id=>wwv_flow_imp.id(180835523821957952)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180836203669957953)
,p_plugin_attribute_id=>wwv_flow_imp.id(180835523821957952)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180836644111957954)
,p_plugin_attribute_id=>wwv_flow_imp.id(180835523821957952)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180837040472957954)
,p_plugin_attribute_id=>wwv_flow_imp.id(180835523821957952)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180837406380957954)
,p_plugin_attribute_id=>wwv_flow_imp.id(180835523821957952)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180837863861957955)
,p_plugin_attribute_id=>wwv_flow_imp.id(180835523821957952)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180838207548957955)
,p_plugin_attribute_id=>wwv_flow_imp.id(180835523821957952)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180838633222957956)
,p_plugin_id=>wwv_flow_imp.id(180830617385957924)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1980881532422071679)
,p_plugin_id=>wwv_flow_imp.id(180830617385957924)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
