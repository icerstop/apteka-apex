...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(180839755477957970)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180840009083957972)
,p_plugin_id=>wwv_flow_imp.id(180839755477957970)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180840320280957973)
,p_plugin_id=>wwv_flow_imp.id(180839755477957970)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180840604410957973)
,p_plugin_id=>wwv_flow_imp.id(180839755477957970)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180840953303957974)
,p_plugin_id=>wwv_flow_imp.id(180839755477957970)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180841225593957974)
,p_plugin_id=>wwv_flow_imp.id(180839755477957970)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180841567066957974)
,p_plugin_id=>wwv_flow_imp.id(180839755477957970)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180841859020957975)
,p_plugin_attribute_id=>wwv_flow_imp.id(180841567066957974)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180842249281957975)
,p_plugin_attribute_id=>wwv_flow_imp.id(180841567066957974)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180842661264957975)
,p_plugin_id=>wwv_flow_imp.id(180839755477957970)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180842917389957976)
,p_plugin_attribute_id=>wwv_flow_imp.id(180842661264957975)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180843325066957976)
,p_plugin_attribute_id=>wwv_flow_imp.id(180842661264957975)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180843794403957977)
,p_plugin_attribute_id=>wwv_flow_imp.id(180842661264957975)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180844158424957977)
,p_plugin_id=>wwv_flow_imp.id(180839755477957970)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180844491361957977)
,p_plugin_attribute_id=>wwv_flow_imp.id(180844158424957977)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180844849092957978)
,p_plugin_attribute_id=>wwv_flow_imp.id(180844158424957977)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180845205681957978)
,p_plugin_attribute_id=>wwv_flow_imp.id(180844158424957977)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1692321971284060161)
,p_plugin_id=>wwv_flow_imp.id(180839755477957970)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
