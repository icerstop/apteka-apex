...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(180845835192957981)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180846179544957982)
,p_plugin_id=>wwv_flow_imp.id(180845835192957981)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180846468017957983)
,p_plugin_id=>wwv_flow_imp.id(180845835192957981)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180846762509957983)
,p_plugin_id=>wwv_flow_imp.id(180845835192957981)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180847082879957983)
,p_plugin_id=>wwv_flow_imp.id(180845835192957981)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180847302042957984)
,p_plugin_id=>wwv_flow_imp.id(180845835192957981)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180847608610957984)
,p_plugin_id=>wwv_flow_imp.id(180845835192957981)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180847928665957984)
,p_plugin_id=>wwv_flow_imp.id(180845835192957981)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180848235456957985)
,p_plugin_id=>wwv_flow_imp.id(180845835192957981)
,p_attribute_scope=>'COMPONENT'
