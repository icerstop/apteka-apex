...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(180858685893958007)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2108096489762029707)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2108095934750029706)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1851203871019756193)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180859524201958014)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180859841189958014)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180860199411958014)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180860433835958015)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180860768852958015)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180861006491958016)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180861325179958016)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(180860768852958015)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2108096489762029707)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180861632597958016)
,p_plugin_attribute_id=>wwv_flow_imp.id(180861325179958016)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180862048651958017)
,p_plugin_attribute_id=>wwv_flow_imp.id(180861325179958016)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180862467551958017)
,p_plugin_attribute_id=>wwv_flow_imp.id(180861325179958016)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180862846547958018)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(180861325179958016)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180863111688958019)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180863419418958019)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180863782447958019)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180864088240958021)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180864333991958021)
,p_plugin_attribute_id=>wwv_flow_imp.id(180864088240958021)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180864709788958022)
,p_plugin_attribute_id=>wwv_flow_imp.id(180864088240958021)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180865148701958022)
,p_plugin_attribute_id=>wwv_flow_imp.id(180864088240958021)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180865541324958022)
,p_plugin_attribute_id=>wwv_flow_imp.id(180864088240958021)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180865902897958023)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(180861006491958016)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2108095934750029706)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180866237410958023)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180866569473958024)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180866893989958024)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180867132417958024)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180867430918958025)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180867741504958025)
,p_plugin_attribute_id=>wwv_flow_imp.id(180867430918958025)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180868189773958026)
,p_plugin_attribute_id=>wwv_flow_imp.id(180867430918958025)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180868570891958026)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180868856162958027)
,p_plugin_attribute_id=>wwv_flow_imp.id(180868570891958026)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180869228765958027)
,p_plugin_attribute_id=>wwv_flow_imp.id(180868570891958026)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180869623978958027)
,p_plugin_attribute_id=>wwv_flow_imp.id(180868570891958026)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180870023009958028)
,p_plugin_attribute_id=>wwv_flow_imp.id(180868570891958026)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180870492636958028)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180870793634958029)
,p_plugin_attribute_id=>wwv_flow_imp.id(180870492636958028)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180871182097958029)
,p_plugin_attribute_id=>wwv_flow_imp.id(180870492636958028)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180871524611958030)
,p_plugin_attribute_id=>wwv_flow_imp.id(180870492636958028)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180871988308958030)
,p_plugin_attribute_id=>wwv_flow_imp.id(180870492636958028)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180872398043958031)
,p_plugin_attribute_id=>wwv_flow_imp.id(180870492636958028)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180872785629958031)
,p_plugin_attribute_id=>wwv_flow_imp.id(180870492636958028)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180873163429958031)
,p_plugin_attribute_id=>wwv_flow_imp.id(180870492636958028)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180873530781958032)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180873874325958032)
,p_plugin_attribute_id=>wwv_flow_imp.id(180873530781958032)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180874221397958033)
,p_plugin_attribute_id=>wwv_flow_imp.id(180873530781958032)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180874634498958033)
,p_plugin_attribute_id=>wwv_flow_imp.id(180873530781958032)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180875044593958034)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180875363230958034)
,p_plugin_attribute_id=>wwv_flow_imp.id(180875044593958034)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180875713700958034)
,p_plugin_attribute_id=>wwv_flow_imp.id(180875044593958034)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180876184482958035)
,p_plugin_attribute_id=>wwv_flow_imp.id(180875044593958034)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180876502654958035)
,p_plugin_attribute_id=>wwv_flow_imp.id(180875044593958034)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180876963930958036)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180877201965958037)
,p_plugin_attribute_id=>wwv_flow_imp.id(180876963930958036)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180877601635958037)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180877961894958038)
,p_plugin_attribute_id=>wwv_flow_imp.id(180877601635958037)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180878465641958039)
,p_plugin_attribute_id=>wwv_flow_imp.id(180877601635958037)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180878862505958039)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180879107659958039)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180879416139958040)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1851203871019756193)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180879742788958040)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180880064581958042)
,p_plugin_attribute_id=>wwv_flow_imp.id(180879742788958040)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180880492532958042)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180880721939958042)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1989310379977851321)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1989311639497855469)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1692358865082092891)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1975716751303444588)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1976396052033527692)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1989308444910806335)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1989309778300820192)
,p_plugin_id=>wwv_flow_imp.id(180858685893958007)
