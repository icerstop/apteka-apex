...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(180886055126958055)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1980904396244841709)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1980903841232841708)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180886724261958061)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180887073690958061)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180887372950958061)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180887616129958062)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180887995312958062)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(180887372950958061)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1980904396244841709)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180888283706958062)
,p_plugin_attribute_id=>wwv_flow_imp.id(180887995312958062)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180888672897958063)
,p_plugin_attribute_id=>wwv_flow_imp.id(180887995312958062)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180889069169958063)
,p_plugin_attribute_id=>wwv_flow_imp.id(180887995312958062)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180889498086958064)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(180887995312958062)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180889753175958064)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180890003710958065)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180890317734958065)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180890663263958065)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180890949135958066)
,p_plugin_attribute_id=>wwv_flow_imp.id(180890663263958065)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180891348794958066)
,p_plugin_attribute_id=>wwv_flow_imp.id(180890663263958065)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180891774301958066)
,p_plugin_attribute_id=>wwv_flow_imp.id(180890663263958065)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180892101062958067)
,p_plugin_attribute_id=>wwv_flow_imp.id(180890663263958065)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180892536404958067)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(180887616129958062)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1980903841232841708)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180892866378958068)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180893106807958068)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180893416377958068)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180893721673958069)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180894007281958069)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180894378941958070)
,p_plugin_attribute_id=>wwv_flow_imp.id(180894007281958069)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180894724765958070)
,p_plugin_attribute_id=>wwv_flow_imp.id(180894007281958069)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180895136578958070)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180895410580958071)
,p_plugin_attribute_id=>wwv_flow_imp.id(180895136578958070)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180895815589958071)
,p_plugin_attribute_id=>wwv_flow_imp.id(180895136578958070)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180896234894958072)
,p_plugin_attribute_id=>wwv_flow_imp.id(180895136578958070)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180896657238958072)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180896917398958072)
,p_plugin_attribute_id=>wwv_flow_imp.id(180896657238958072)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180897334998958073)
,p_plugin_attribute_id=>wwv_flow_imp.id(180896657238958072)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180897786434958073)
,p_plugin_attribute_id=>wwv_flow_imp.id(180896657238958072)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180898122666958074)
,p_plugin_attribute_id=>wwv_flow_imp.id(180896657238958072)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180898566118958074)
,p_plugin_attribute_id=>wwv_flow_imp.id(180896657238958072)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180898922203958075)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(180899274883958075)
,p_plugin_attribute_id=>wwv_flow_imp.id(180898922203958075)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180899645232958075)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1981107448401988337)
,p_plugin_id=>wwv_flow_imp.id(180886055126958055)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
