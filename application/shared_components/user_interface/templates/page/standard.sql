...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(180678387864957749)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180678668712957750)
,p_page_template_id=>wwv_flow_imp.id(180678387864957749)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180678910772957751)
,p_page_template_id=>wwv_flow_imp.id(180678387864957749)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180679265024957751)
,p_page_template_id=>wwv_flow_imp.id(180678387864957749)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180679598566957751)
,p_page_template_id=>wwv_flow_imp.id(180678387864957749)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180679828378957751)
,p_page_template_id=>wwv_flow_imp.id(180678387864957749)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180680140522957751)
,p_page_template_id=>wwv_flow_imp.id(180678387864957749)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180680461576957752)
,p_page_template_id=>wwv_flow_imp.id(180678387864957749)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180680772773957752)
,p_page_template_id=>wwv_flow_imp.id(180678387864957749)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180681001983957752)
,p_page_template_id=>wwv_flow_imp.id(180678387864957749)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180681309891957752)
,p_page_template_id=>wwv_flow_imp.id(180678387864957749)
