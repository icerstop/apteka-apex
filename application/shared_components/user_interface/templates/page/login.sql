...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(180663113663957736)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180663414014957736)
,p_page_template_id=>wwv_flow_imp.id(180663113663957736)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180663709362957736)
,p_page_template_id=>wwv_flow_imp.id(180663113663957736)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180664013832957736)
,p_page_template_id=>wwv_flow_imp.id(180663113663957736)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180664388643957737)
,p_page_template_id=>wwv_flow_imp.id(180663113663957736)
,p_name=>'Body Footer'
