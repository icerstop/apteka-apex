...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(180669782966957742)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180670057957957743)
,p_page_template_id=>wwv_flow_imp.id(180669782966957742)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180670352705957743)
,p_page_template_id=>wwv_flow_imp.id(180669782966957742)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180670635023957744)
,p_page_template_id=>wwv_flow_imp.id(180669782966957742)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180670904823957744)
,p_page_template_id=>wwv_flow_imp.id(180669782966957742)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180671202848957744)
,p_page_template_id=>wwv_flow_imp.id(180669782966957742)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180671511877957744)
,p_page_template_id=>wwv_flow_imp.id(180669782966957742)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180671868432957744)
,p_page_template_id=>wwv_flow_imp.id(180669782966957742)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180672102608957745)
,p_page_template_id=>wwv_flow_imp.id(180669782966957742)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180672421584957745)
,p_page_template_id=>wwv_flow_imp.id(180669782966957742)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180672713088957745)
,p_page_template_id=>wwv_flow_imp.id(180669782966957742)
