...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(180674656621957747)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180674967200957747)
,p_page_template_id=>wwv_flow_imp.id(180674656621957747)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180675257588957747)
,p_page_template_id=>wwv_flow_imp.id(180674656621957747)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180675572947957748)
,p_page_template_id=>wwv_flow_imp.id(180674656621957747)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180675874157957748)
,p_page_template_id=>wwv_flow_imp.id(180674656621957747)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180676126501957748)
,p_page_template_id=>wwv_flow_imp.id(180674656621957747)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180676452999957748)
,p_page_template_id=>wwv_flow_imp.id(180674656621957747)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180676724297957748)
,p_page_template_id=>wwv_flow_imp.id(180674656621957747)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180677087541957749)
,p_page_template_id=>wwv_flow_imp.id(180674656621957747)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180677393013957749)
,p_page_template_id=>wwv_flow_imp.id(180674656621957747)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180677608132957749)
,p_page_template_id=>wwv_flow_imp.id(180674656621957747)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180677980055957749)
,p_page_template_id=>wwv_flow_imp.id(180674656621957747)
