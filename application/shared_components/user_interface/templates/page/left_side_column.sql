...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(180655455882957724)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180655708256957726)
,p_page_template_id=>wwv_flow_imp.id(180655455882957724)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180656003846957726)
,p_page_template_id=>wwv_flow_imp.id(180655455882957724)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180656335947957727)
,p_page_template_id=>wwv_flow_imp.id(180655455882957724)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180656688716957729)
,p_page_template_id=>wwv_flow_imp.id(180655455882957724)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180656904226957729)
,p_page_template_id=>wwv_flow_imp.id(180655455882957724)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180657257559957729)
,p_page_template_id=>wwv_flow_imp.id(180655455882957724)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180657537236957730)
,p_page_template_id=>wwv_flow_imp.id(180655455882957724)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180657847726957730)
,p_page_template_id=>wwv_flow_imp.id(180655455882957724)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180658186677957730)
,p_page_template_id=>wwv_flow_imp.id(180655455882957724)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180658402802957730)
,p_page_template_id=>wwv_flow_imp.id(180655455882957724)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180658703490957730)
,p_page_template_id=>wwv_flow_imp.id(180655455882957724)
