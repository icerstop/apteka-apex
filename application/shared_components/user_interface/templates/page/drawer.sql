...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(180652524658957697)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180652861118957711)
,p_page_template_id=>wwv_flow_imp.id(180652524658957697)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180653136254957715)
,p_page_template_id=>wwv_flow_imp.id(180652524658957697)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180653472342957715)
,p_page_template_id=>wwv_flow_imp.id(180652524658957697)
