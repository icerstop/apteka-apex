...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(180752318158957820)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180752647281957820)
,p_plug_template_id=>wwv_flow_imp.id(180752318158957820)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180752970332957821)
,p_plug_template_id=>wwv_flow_imp.id(180752318158957820)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180753263131957821)
,p_plug_template_id=>wwv_flow_imp.id(180752318158957820)
,p_name=>'Sub Regions'
