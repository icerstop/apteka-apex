...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(180695595693957770)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180695812559957770)
,p_plug_template_id=>wwv_flow_imp.id(180695595693957770)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180696179372957770)
,p_plug_template_id=>wwv_flow_imp.id(180695595693957770)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180696471238957771)
,p_plug_template_id=>wwv_flow_imp.id(180695595693957770)
,p_name=>'Sub Regions'
