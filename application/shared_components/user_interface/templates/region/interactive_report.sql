...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(180745201244957815)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180745502731957815)
,p_plug_template_id=>wwv_flow_imp.id(180745201244957815)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180745879368957815)
,p_plug_template_id=>wwv_flow_imp.id(180745201244957815)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180746125799957815)
,p_plug_template_id=>wwv_flow_imp.id(180745201244957815)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180746491545957816)
,p_plug_template_id=>wwv_flow_imp.id(180745201244957815)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180746750390957816)
,p_plug_template_id=>wwv_flow_imp.id(180745201244957815)
,p_name=>'Sub Regions'
