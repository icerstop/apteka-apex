...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(180739801579957811)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180740133868957811)
,p_plug_template_id=>wwv_flow_imp.id(180739801579957811)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180740430614957811)
,p_plug_template_id=>wwv_flow_imp.id(180739801579957811)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180740726007957811)
,p_plug_template_id=>wwv_flow_imp.id(180739801579957811)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180741014425957811)
,p_plug_template_id=>wwv_flow_imp.id(180739801579957811)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180741358086957812)
,p_plug_template_id=>wwv_flow_imp.id(180739801579957811)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180741653617957812)
,p_plug_template_id=>wwv_flow_imp.id(180739801579957811)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180741927914957812)
,p_plug_template_id=>wwv_flow_imp.id(180739801579957811)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180742230178957812)
,p_plug_template_id=>wwv_flow_imp.id(180739801579957811)
,p_name=>'Sub Regions'
