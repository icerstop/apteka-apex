...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(180767403354957834)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180767756501957834)
,p_plug_template_id=>wwv_flow_imp.id(180767403354957834)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180768048943957834)
,p_plug_template_id=>wwv_flow_imp.id(180767403354957834)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180768368204957834)
,p_plug_template_id=>wwv_flow_imp.id(180767403354957834)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180768641802957835)
,p_plug_template_id=>wwv_flow_imp.id(180767403354957834)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180768987614957835)
,p_plug_template_id=>wwv_flow_imp.id(180767403354957834)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180769258249957835)
,p_plug_template_id=>wwv_flow_imp.id(180767403354957834)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180769578402957835)
,p_plug_template_id=>wwv_flow_imp.id(180767403354957834)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180769820902957835)
,p_plug_template_id=>wwv_flow_imp.id(180767403354957834)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180770125055957836)
,p_plug_template_id=>wwv_flow_imp.id(180767403354957834)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180770445224957836)
,p_plug_template_id=>wwv_flow_imp.id(180767403354957834)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180770717867957836)
,p_plug_template_id=>wwv_flow_imp.id(180767403354957834)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180771024797957836)
,p_plug_template_id=>wwv_flow_imp.id(180767403354957834)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180771345981957836)
,p_plug_template_id=>wwv_flow_imp.id(180767403354957834)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
