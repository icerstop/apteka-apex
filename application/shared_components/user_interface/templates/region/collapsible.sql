...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(180707304460957781)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180707658644957782)
,p_plug_template_id=>wwv_flow_imp.id(180707304460957781)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180707935268957782)
,p_plug_template_id=>wwv_flow_imp.id(180707304460957781)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180708235533957782)
,p_plug_template_id=>wwv_flow_imp.id(180707304460957781)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180708514615957782)
,p_plug_template_id=>wwv_flow_imp.id(180707304460957781)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180708818548957782)
,p_plug_template_id=>wwv_flow_imp.id(180707304460957781)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180709144680957783)
,p_plug_template_id=>wwv_flow_imp.id(180707304460957781)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180709480973957783)
,p_plug_template_id=>wwv_flow_imp.id(180707304460957781)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180709768257957783)
,p_plug_template_id=>wwv_flow_imp.id(180707304460957781)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180710079075957783)
,p_plug_template_id=>wwv_flow_imp.id(180707304460957781)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180710309640957783)
,p_plug_template_id=>wwv_flow_imp.id(180707304460957781)
,p_name=>'Sub Regions'
