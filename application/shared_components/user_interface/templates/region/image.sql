...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(180725283717957798)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180725587410957798)
,p_plug_template_id=>wwv_flow_imp.id(180725283717957798)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180725879137957798)
,p_plug_template_id=>wwv_flow_imp.id(180725283717957798)
,p_name=>'Sub Regions'
