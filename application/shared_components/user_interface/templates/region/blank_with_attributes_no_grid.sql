...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(180689874607957765)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180690162632957765)
,p_plug_template_id=>wwv_flow_imp.id(180689874607957765)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180690457762957765)
,p_plug_template_id=>wwv_flow_imp.id(180689874607957765)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180690723996957765)
,p_plug_template_id=>wwv_flow_imp.id(180689874607957765)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180691043890957765)
,p_plug_template_id=>wwv_flow_imp.id(180689874607957765)
,p_name=>'Sub Regions'
