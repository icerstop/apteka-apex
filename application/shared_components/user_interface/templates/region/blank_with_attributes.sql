...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(180688443351957763)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180688785845957764)
,p_plug_template_id=>wwv_flow_imp.id(180688443351957763)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180689091706957764)
,p_plug_template_id=>wwv_flow_imp.id(180688443351957763)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180689395863957764)
,p_plug_template_id=>wwv_flow_imp.id(180688443351957763)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180689697832957764)
,p_plug_template_id=>wwv_flow_imp.id(180688443351957763)
,p_name=>'Sub Regions'
