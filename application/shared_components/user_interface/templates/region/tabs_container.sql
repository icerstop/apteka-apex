...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(180764812753957832)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180765156332957832)
,p_plug_template_id=>wwv_flow_imp.id(180764812753957832)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180765467312957832)
,p_plug_template_id=>wwv_flow_imp.id(180764812753957832)
,p_name=>'Tabs'
