...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(180772514815957837)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180772883962957838)
,p_plug_template_id=>wwv_flow_imp.id(180772514815957837)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180773165068957838)
,p_plug_template_id=>wwv_flow_imp.id(180772514815957837)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180773474088957838)
,p_plug_template_id=>wwv_flow_imp.id(180772514815957837)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180773785914957838)
,p_plug_template_id=>wwv_flow_imp.id(180772514815957837)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180774068112957838)
,p_plug_template_id=>wwv_flow_imp.id(180772514815957837)
