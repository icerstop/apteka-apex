...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(180717124709957791)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180717413969957791)
,p_plug_template_id=>wwv_flow_imp.id(180717124709957791)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180717721238957792)
,p_plug_template_id=>wwv_flow_imp.id(180717124709957791)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180718034729957792)
,p_plug_template_id=>wwv_flow_imp.id(180717124709957791)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180718314456957792)
,p_plug_template_id=>wwv_flow_imp.id(180717124709957791)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180718664242957792)
,p_plug_template_id=>wwv_flow_imp.id(180717124709957791)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180718925376957792)
,p_plug_template_id=>wwv_flow_imp.id(180717124709957791)
,p_name=>'Sub Regions'
