...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(180730613746957803)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180730948363957803)
,p_plug_template_id=>wwv_flow_imp.id(180730613746957803)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180731217475957804)
,p_plug_template_id=>wwv_flow_imp.id(180730613746957803)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180731507113957804)
,p_plug_template_id=>wwv_flow_imp.id(180730613746957803)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180731820946957804)
,p_plug_template_id=>wwv_flow_imp.id(180730613746957803)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180732166849957804)
,p_plug_template_id=>wwv_flow_imp.id(180730613746957803)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180732455145957804)
,p_plug_template_id=>wwv_flow_imp.id(180730613746957803)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180732768255957805)
,p_plug_template_id=>wwv_flow_imp.id(180730613746957803)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180733000823957805)
,p_plug_template_id=>wwv_flow_imp.id(180730613746957803)
,p_name=>'Sub Regions'
