...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(180721782340957794)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180722060920957795)
,p_plug_template_id=>wwv_flow_imp.id(180721782340957794)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180722314268957795)
,p_plug_template_id=>wwv_flow_imp.id(180721782340957794)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180722684962957796)
,p_plug_template_id=>wwv_flow_imp.id(180721782340957794)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180722956823957796)
,p_plug_template_id=>wwv_flow_imp.id(180721782340957794)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180723232493957796)
,p_plug_template_id=>wwv_flow_imp.id(180721782340957794)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
