...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(180747329680957816)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180747671219957817)
,p_plug_template_id=>wwv_flow_imp.id(180747329680957816)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180747960353957817)
,p_plug_template_id=>wwv_flow_imp.id(180747329680957816)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180748295790957817)
,p_plug_template_id=>wwv_flow_imp.id(180747329680957816)
,p_name=>'Button Start'
