...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(180735278264957807)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180735505449957807)
,p_plug_template_id=>wwv_flow_imp.id(180735278264957807)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180735800735957807)
,p_plug_template_id=>wwv_flow_imp.id(180735278264957807)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180736196692957807)
,p_plug_template_id=>wwv_flow_imp.id(180735278264957807)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180736437236957807)
,p_plug_template_id=>wwv_flow_imp.id(180735278264957807)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180736782882957808)
,p_plug_template_id=>wwv_flow_imp.id(180735278264957807)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180737085816957808)
,p_plug_template_id=>wwv_flow_imp.id(180735278264957807)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180737364895957808)
,p_plug_template_id=>wwv_flow_imp.id(180735278264957807)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180737676883957808)
,p_plug_template_id=>wwv_flow_imp.id(180735278264957807)
,p_name=>'Sub Regions'
