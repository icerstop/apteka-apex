...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(180749839864957818)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180750196799957818)
,p_plug_template_id=>wwv_flow_imp.id(180749839864957818)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180750470955957819)
,p_plug_template_id=>wwv_flow_imp.id(180749839864957818)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180750745447957819)
,p_plug_template_id=>wwv_flow_imp.id(180749839864957818)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180751009168957819)
,p_plug_template_id=>wwv_flow_imp.id(180749839864957818)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(180751392694957819)
,p_plug_template_id=>wwv_flow_imp.id(180749839864957818)
,p_name=>'Sub Regions'
